  ...
  return (
    <section ref={sectionAnimation.ref as React.RefObject<HTMLElement>} className={`relative py-16 sm:py-20 md:py-28 overflow-hidden scroll-animate ${sectionAnimation.isVisible ? 'visible' : ''}`}>
      <div
        ...
        style={{ backgroundImage: 'url(/Caribbean2.jpg)' }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <button
          onClick={onBookNow}
          className="w-full sm:w-64 bg-[#F5E531] text-[#222222] py-4 sm:py-5 rounded-lg text-base sm:text-lg font-bold hover:bg-[#E5D521] transition-all transform hover:scale-105 shadow-xl"
        >
          BOOK NOW
        </button>
        ...
        <p className="text-xs sm:text-sm md:text-base text-white/90 drop-shadow-md mt-4">
          No blackout dates • Book now, pick dates later • 100% refundable
        </p>
      </div>
    </section>
  );
